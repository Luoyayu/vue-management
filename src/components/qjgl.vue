...
export default {
  ...
  data() {
    return {
      sendArray: [], //sendArray.lenth=this.lenth
      showDialog: false,
      useable: false,
      tempobjects: [],
      objects: [],
  ...
  methods: {
    ...
    change(newstatus, obj) {
      ...
      this.flag = true;
      this.sendArray.splice(index, 0, returnobjects_);
    ...
    all_agree() {
      ...
      for (let i = 0; i < this.selected.length; i++) {
        ...
        returnobjects_.wk_number = this.tempobjects[i].wk_number;
        returnobjects_.qj_date = this.tempobjects[i].qj_date;
        returnobjects_.permission = this.tempobjects[i].qj_state;
        this.sendArray.splice(i, 0, returnobjects_);
      }
      this.flag = true;
    },
